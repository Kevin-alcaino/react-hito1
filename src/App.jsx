    ...
    <>
      ...
      <div className="cont-producto">
        <CardPizza
          ...
          price={10990}
          onnAddToCart={() => addToCart({ img: margarita, name: "Pizza Margarita", description: "Una pizza clásica con tomate, mozzarella y albahaca", price: 10990 })}
        />
        <CardPizza
          img={marina}
          name="Pizza Marinara"
          ...
          price={8990}
          onnAddToCart={() => addToCart({ img: marina, name: "Pizza Marinara", description: "Una pizza con salsa de tomate, ajo y orégano", price: 8990 })}
        />
        <CardPizza
          img={veggie}
          name="Pizza Veggie"
          ...
          price={12990}
          onnAddToCart={() => addToCart({ img: veggie, name: "Pizza Veggie", description: "Una pizza con una variedad de vegetales frescos", price: 12990 })}
        />
        <CardPizza
          img={carbonara}
          ...
          price={14990}
          onnAddToCart={() => addToCart({ img: carbonara, name: "Pizza Carbonara", description: "Una pizza con salsa carbonara, panceta y huevo", price: 14990 })}
        />
        <CardPizza
          img={caprichoza}
          ...
          price={14990}
          onnAddToCart={() => addToCart({ img: caprichoza, name: "Pizza Caprichoza", description: "Una pizza con jamón, champiñones y aceitunas", price: 14990 })}
